            ...
            <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                ...
                <li class="dropdown notification-list topbar-dropdown">
                    <a class="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown" href="#"
                        ...
                        <img src="{{ auth()->guard('admin')->user()->avatar }}" alt="user-image" class="rounded-circle">
                    ...
                    <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                        ...
                        <div class="dropdown-header noti-title">
                            <h6 class="text-overflow m-0">{{ __('common.topbar.welcome') }} !</h6>
                        </div>

                        <!-- item-->
                        <a href="{{ route('admin.account.profile.index') }}" class="dropdown-item notify-item">
                            <i class="mdi mdi-account-circle-outline fs-16 align-middle"></i>
                            <span>My Account</span>
                        </a>

                        <!-- item-->
                        <a href="{{ route('admin.account.profile.edit') }}" class="dropdown-item notify-item">
                            <i class="mdi mdi-card-account-details-outline fs-16 align-middle"></i>
                            <span>Profile Update</span>
                        </a>

                        <!-- item-->
                        <a href="{{ route('account.password.change') }}" class="dropdown-item notify-item">
