<x-user-auth-layout>
    @section('title', __('NSDL | PanCard Detail'))
    @section('page-title', 'NSDL | PanCard Detail')
    @section('breadcrumb')
        {{ Breadcrumbs::render('nsdl.pan-card.show', $panCard) }}
    @endsection
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span id="order_id">{{ $panCard->acknowledgement_no ? $panCard->acknowledgement_no :"null" }}</span></td>
                        </tr>
                        <tr>
